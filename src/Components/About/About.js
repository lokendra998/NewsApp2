...
const About=()=>{
    return(
        <div>
        <h1 style={{fontWeight:'bold',textAlign:'center',color:'green',textDecoration:'underline'}}>About NewsCitizen</h1>
...
The line between old media and new media has blurred, practically beyond recognition.[180]
These alterations inevitably have fundamental ramifications for the contemporary ecology of news. "The boundaries of journalism, which just a few years ago seemed relatively clear, and permanent, have become less distinct, and this blurring, while potentially the foundation of progress even as it is the source of risk, has given rise to a new set of journalistic principles and practices",[181] Schudson puts it. It is indeed complex, but it seems to be the future.

Online news has also changed the geographic reach of individual news stories, diffusing readership from city-by-city markets to a potentially global audience.[166]
...
Despite these changes, some studies have concluded that internet news coverage remains fairly homogenous and dominated by news agencies.[182][183] And journalists working with online media do not identify significantly different criteria for newsworthiness than print journalists.[24]

News agencies
Main article: News agency

Reuters office in Bonn, Germany, 1988
News agencies are services which compile news and disseminate it in bulk. Because they disseminate information to a wide variety of clients, who repackage the material as news for public consumption, news agencies tend to use less controversial language in their reports. Despite their importance, news agencies are not well known by the general public. They keep low profiles and their reporters usually do not get bylines.[19][184]

The oldest news agency still operating is the Agence France-Presse (AFP).[185] It was founded in 1835 by a Parisian translator and advertising agent, Charles-Louis Havas as Agence Havas. By the end of the twentieth century, Reuters far outpaced the other news agencies in profits, and became one of the largest companies in Europe.[186] In 2011, Thomson Reuters employed more than 55,000 people in 100 countries, and posted an annual revenue of $12.9 billion.[19]
...
News agencies, especially Reuters and the newly important Bloomberg News, convey both news stories for mass audiences and financial information of interest to businesses and investors.[187][188] Bloomberg LP, a private company founded by Michael Bloomberg in 1981, made rapid advances with computerized stock market reporting updated in real time. Its news service continued to exploit this electronic advantage by combining computer-generated analytics with text reporting. Bloomberg linked with Agence France Presse in the 1990s.[188]

Following the marketization of the Chinese economy and the media boom of the 1990s, Xinhua has adopted some commercial practices including subscription fees, but it remains government-subsidized. It provides newswire, news photos, economic information, and audio and video news. Xinhua has a growing number of subscribers, totaling 16,969 in 2002, including 93% of Chinese newspapers.[136] It operates 123 foreign bureaus and produces 300 news stories each day.[189]

Other agencies with considerable reach include Deutsche Presse-Agentur (Germany), Kyodo News (Japan), the Agenzia Nazionale Stampa Associata (Italy), the Middle East News Agency (Egypt), Tanjug (Serbia), EFE (Spain), and Anadolu Agency (Turkey).[190]

On the internet, news aggregators play a role similar to that of the news agency—and, because of the sources they select, tend to transmit news stories which originate from the main agencies. Of articles displayed by Yahoo! News in the U.S., 91.7% come from news agencies: 39.4% from AP, 30.9% AFP, and 21.3% Reuters. In India, 60.1% of Yahoo! News stories come from Reuters. Google News relies somewhat less on news agencies, and has shown high volatility, in the sense of focusing heavily on the most recent handful of salient world events.[182] In 2010, Google News redesigned its front page with automatic geotargeting, which generated a selection of local news items for every viewer.[191]

Global news system
In the 20th century, global news coverage was dominated by a combination of the "Big Four" news agencies—Reuters, Associated Press, Agence France Press, and United Press International—representing the Western bloc, and the Communist agencies: TASS from the Soviet Union, and Xinhua from China.[192] Studies of major world events, and analyses of all international news coverage in various newspapers, consistently found that a large majority of news items originated from the four biggest wire services.[182]

Television news agencies include Associated Press Television News, which bought and incorporated World Television News; and Reuters Television.[175][193] Bloomberg News created in the 1990s, expanded rapidly to become a player in the realm of international news.[187] The Associated Press also maintains a radio network with thousands of subscribers worldwide; it is the sole provider of international news to many small stations.[175]

By some accounts, dating back to the 1940s, the increasing interconnectedness of the news system has accelerated the pace of world history itself.[194]

New World Information and Communication Order
The global news system is dominated by agencies from Europe and the United States, and reflects their interests and priorities in its coverage.[195] Euro-American control of the global news system has led to criticism; that events around the world are constantly compared to events like the Holocaust and World War II, which are considered foundational in the West.[196] Since the 1960s, a significant amount of news reporting from the Third World has been characterized by some form "development journalism", a paradigm which focuses on long-term development projects, social change, and nation-building.[197] When in 1987 the U.S. media reported on a riot in the Dominican Republic—the first major news item regarding that country in years—the resulting decline in tourism lasted for years and had a noticeable effect on the economy.[198] The English language predominates in global news exchanges.[199] Critics have accused the global news system of perpetuating cultural imperialism.[163][200][201] Critics further charge that the Western media conglomerates maintain a bias towards the status quo economic order, especially a pro-corporate bias.[200]

The United Nations Educational, Scientific and Cultural Organization (UNESCO) has promoted a New World Information and Communication Order, which envisions an international news exchange system involving national news agencies in every country. UNESCO encouraged the new states formed from colonial territories in the 1960s to establish news agencies, to generate domestic news stories, exchange news items with international partners, and disseminate both types of news internally.[202] Along these lines, the 1980 MacBride report, "Many Voices, One World", called for an interdependent global news system with more participation from different governments. To this end, also, UNESCO formed the Non-Aligned News Agencies Pool.[203]

The Inter Press Service, founded in 1964, has served as an intermediary for Third World press agencies.[204] Inter Press Service's editorial policy favors coverage of events, institutions, and issues which relate to inequality, economic development, economic integration, natural resources, population, health, education, and sustainable development.[205] It gives less coverage than other agencies to crime, disasters, and violence. Geographically, 70% of its news reporting concerns Africa, Asia, Latin America, and the Caribbean.[206] IPS has the most subscribers in Latin America and southern Africa.[205] IPS receives grants from organizations such as the United Nations Development Program and other United Nations agencies and private foundations to report news on chosen topics, including the environment, sustainable development, and women's issues.[207]

Beginning in the 1960s, the United States Agency for International Development, the National Aeronautics and Space Administration, and UNESCO developed the use of satellite television for international broadcasting. In India, 1975–1976, these agencies implemented an experimental satellite television system, called the Satellite Instructional Television Experiment, with assistance from the Indian Space Research Organisation, and All India Radio.[208]

Further transformation in global news flow
By the 1980s, much of the Third World had succumbed to a debt crisis resulting from unpayable large loans accumulated since the 1960s. At this point, the World Bank took an active role in the governance of many countries, and its authority extended to communications policy. The policy of developing Third World media gave way to a global regime of free trade institutions like the World Trade Organization, which also protected the free flow of information across borders.[209] The World Bank also promoted privatization of national telecommunications, which afforded large multinational corporations the opportunity to purchase networks and expand operations in the Third World.[210][211]

In countries with less telecommunications infrastructure, people, especially youth, tend today to get their news predominantly from mobile phones and, less so, from the internet. Older folks listen more to the radio. The government of China is a major investor in Third World telecommunications, especially in Africa.[212] Some issues relating to global information flow were revisited in light of the internet at the 2003/2005 World Summit on the Information Society, a conference which emphasized the role of civil society and the private sector in information society governance.[213]
...
Images connected with news can also become iconic and gain a fixed role in the culture. Examples such as Alfred Eisenstaedt's photograph V-J Day in Times Square, Nick Ut's photograph of Phan Thi Kim Phuc and other children running from a napalm blast in Vietnam; Kevin Carter's photograph of a starving child being stalked by a vulture;[196] etc.

With the new interconnectedness of global media, the experience of receiving news along with a world audience reinforces the social cohesion effect on a larger scale.[285] As a corollary, global media culture may erode the uniqueness and cohesion of national cultures.[200]
...
South Africans overwhelmingly describe the end of Apartheid as a source of the country's most important news.[300] In the United States, news events such as the assassinations of the 1960s (of John F. Kennedy, Martin Luther King, Jr., and Robert F. Kennedy), the 1969 moon landing, the 1986 Challenger explosion, the 1997 death of Princess Diana, the intervention of the Supreme Court in the 2000 presidential election and the 2001 September 11 attacks.[301] In Jordan, people cited numerous memorable news events involving death and war, including the death of King Hussein, Princess Diana, and Yitzhak Rabin. Positive news stories found memorable by Jordanians featured political events affecting their lives and families—such as the Israeli withdrawal from South Lebanon, and the Israel–Jordan peace treaty.[302]
...
See also: Media influence and Cultivation theory
...
It has been acknowledged that sponsorship has historically influenced various news stories.[318][319][320] This history gained widespread attention following the release of the film Anchorman 2.[318][319][320] One example in recent time is the fact that Facebook has invested heavily in news sources and purchasing time on local news media outlets.[321][322] Tech Crunch journalist Josh Continue even stated in February 2018 that the company "stole the news business" and used sponsorship to make many news publishers its "ghostwriters."[321] In January 2019, founder Mark Zuckerberg announced that he will spend $300 million in local news buys over a three-year period.[322][323]
...
References
 ...
 "Online Etymology Dictionary". Retrieved 7 July 2012.
 "Etymology of News".
 "Mrs. John Cosgrave Is Dead Founded Finch Junior College: Was Institution's President Nearly 50 Years; Coined 'Current Events' Phrase". New York Herald Tribune. 1 November 1949.
 ...
 Park, "News as a Form of Knowledge" (1940), pp. 675–676. "News is not history because, for one thing among others, it deals, on the whole, with isolated events and does not seek to relate them to one another either in the form of causal or in the form of Teleological sequences."
 ...
 Strömbäck, Jesper; Karlsson, Michael; Hopmann, Nicolas (2012). "Determinants of News Content: Comparing journalists' perceptions of the normative and actual impact of different event properties when deciding what's news". Journalism Studies. 13: 5–6. doi:10.1080/1461670X.2012.664321. S2CID 55642544.
 Stephens, History of News (1988), pp. 26, 105–106.
 Allan, News Culture (2004), p. 202.
 "definition of newsworthiness by the Free Online Dictionary, Thesaurus, and Encyclopedia". Thefreedictionary.com. Retrieved 9 March 2012.
 ...
 [1] Archived 19 May 2011 at the Wayback Machine
 Bleumer, Gerrit (2007). Electronic Postage Systems: Technology, Security, Economics. p. 2. ISBN 9780387446066.
 Allan, News Culture (2004), p. 9.
 ...
 Stephens, History of News (1988), pp. 24–25.
 Bakker, "Trading Facts" (2011), p. 13.
 Starr, Creation of the Media (2004), pp. 156–157.
 Distelrath, "Development of the Information and Communication Systems in Germany and Japan" (2000), pp. 45–46 .
 ...
 Smith,The Newspaper: An International History (1979), p. 14–15.
 ...
 Smith,The Newspaper: An International History (1979), p. 14. "At a later stage of its development, during the Sung period (960–1278), the ti pao was made to circulate among the purely intellectual groups, and during the Ming (1367–1644) was seen by a wider circle of society."
 Brook, Timothy. (1998). The Confusions of Pleasure: Commerce and Culture in Ming China. Berkeley: University of California Press. ISBN 0-520-22154-0 p. xxi.
 Stephens, History of News (1988), pp. 68–69.
 ...
 Wan-Press.org Archived 11 January 2012 at the Wayback Machine, A Newspaper Timeline, World Association of Newspapers
 Infelise, Mario. "Roman Avvisi: Information and Politics in the Seventeenth Century." in Court and Politics in Papal Rome, 1492–1700(Cambridge University Press, 2002) pp. 212, 214, 216–217
 ...
 Pettegree, The Invention of News (2014), p. 5.
 Lampe & Ploeckl, "Spanning the Globe" (2014), 248.
 Pettegree, The Invention of News (2014), pp. 17–18.
 Starr, Creation of the Media (2004), pp. 30–31.
 ...
 Lim, "Take Writing" (2006), pp. 35–45.
 Bakker, "Trading Facts" (2011), pp. 10–11.
 ...
 Pettegree, The Invention of News (2014), p. 8.
 Weber 2006, p. 396; World Association of Newspapers: "Newspapers: 400 Years Young!" Archived 10 March 2010 at the Wayback Machine
 ...
 Cranfield, Press and Society (1978), p. 1.
 Heyd, Reading newspapers (2012), p. 11.
 Heyd, Reading newspapers (2012), pp. 15–16.
 Starr, Creation of the Media (2004), p. 29.
 Starr, Creation of the Media (2004), pp. 43–44.
 Bakker, "Trading Facts" (2011), p. 30.
 Starr, Creation of the Media (2004), pp. 69–73.
 ...
 Cloud, Frontier Press (2008), pp. 8–9, 22–23.
 Cloud, Frontier Press (2008), pp. 31, 73.
 Cloud, Frontier Press (2008), pp. 67–69.
 ...
 Fosu, "The Press and Political Participation" (2014), pp. 60–61.
 ...
 Bakker, "Trading Facts" (2011), p. 15.
 Starr, Creation of the Media (2004), p. 180.
 Salmon, The Newspaper and the Historian (1923), p. 118.
 Salmon, The Newspaper and the Historian (1923), pp. 117–118.
 Wenzlhuemer, Connecting the Nineteenth-Century World (2013), pp. 90–92.
 Hachten, World News Prism (1996), p. 43.
 Starr, Creation of the Media (2004), pp. 175–177.
 Bakker, "Trading Facts" (2011), p. 16.
 Allan, News Culture (2004), p. 17.
 Headrick, Daniel R.; Griset, Pascal. "Submarine Telegraph Cables: Business and Politics, 1838–1939". Business History Review. 75 (3).
 Graham Meikle, Interpreting News; Palgrave Macmillan, 2009; p. 152.
 ...
 Bakker, "Trading Facts" (2011), p. 22.
 Bakker, "Trading Facts" (2011), p. 36.
 Bakker, "Trading Facts" (2011), p. 23.
 Bakker, "Trading Facts" (2011), p. 28.
 Michael Palmer, "What Makes News", in Boyd-Barrett & Rantanen, The Globalization of News (1998), pp. 180–181.
 ...
 Michael Palmer, "What Makes News", in Boyd-Barrett & Rantanen, The Globalization of News (1998), pp. 182–183.
 Allan, News Culture (2004), pp. 18–19.
 ...
 Bakker, "Trading Facts" (2011), p. 33.
 Allan, News Culture (2004), pp. 26–27.
 ...
 Allan, News Culture (2004), p. 33.
 Allan, News Culture (2004), p. 34.
 ...
 Allan, News Culture (2004), p. 29.
 Wood, History of International Broadcasting (1992), p. 51.
 Wood, History of International Broadcasting (1992), pp. 45.
 Wood, History of International Broadcasting (1992), pp. 87–91.
 Wood, History of International Broadcasting (1992), pp. 39, 105.
 Wood, History of International Broadcasting (1992), pp. 108–114, 132.
 Allan, News Culture (2004), p. 42–44.
 Straubhaar and LaRose, Communications Media in the Information Society (1997), p. 209.
 Straubhaar and LaRose, Communications Media in the Information Society (1997), pp. 179, 210.
 McNair, Cultural Chaos (2006), pp. 108–114.
 Hachten, World News Prism (1996), p. 34.
 ...
 Hachten, World News Prism (1996), pp. 54–55.
 John Tomlinson, "Cultural Globalization and Cultural Imperialism", in Mohammadi (ed.), International Communication and Globalization (1997).
 McNair, Cultural Chaos (2006), p. 118.
 Allan, News Culture (2004), p. 173.
 Shelley Thompson, "The Future of Newspapers in a Digital Age", in Fowler-Watt & Allan (eds.), Journalism (2013).
 Shane Richmond, "Telegraph.co.uk: 15 years of online news"; The Telegraph, 11 November 2009.
 Allan, News Culture (2004), pp. 175–176.
 McNair, Cultural Chaos (2006), pp. 1–2.
 Hachten, World News Prism (1996), p. 8.
 ...
 Allan, News Culture (2004), p. 100.
 Hachten, World News Prism (1996), pp. 39–41.
 McNair, Cultural Chaos (2006), pp. 124–133.
 ...
 Schudson, Michael (2011). The Sociology of News (2nd ed.). p. 205. ISBN 978-0-393-91287-6.
 Schudson, Michael (2011). The Sociology of News (2nd ed.). pp. 207–216.
 Schudson, Michael (2011). The Sociology of News (2nd ed.). p. 207.
 Watanabe, Kohei (2013). "The western perspective in Yahoo! News and Google News: Quantitative analysis of geographic coverage of online news". International Communication Gazette. 75 (2): 141–156. doi:10.1177/1748048512465546. S2CID 143123659.
 ...
 Johnston, Jane; Forde, Susan (2011). ""The Silent Partner: News Agencies and 21st Century News";". International Journal of Communication. 5.
 Broderick, James F.; Darren W. Miller (2007). Consider the source: A Critical Guide to 100 Prominent News and Information Sites on the Web. Information Today, Inc. p. 1. ISBN 978-0-910965-77-4.
 ...
 John Bartram Ewha, "News Agency Wars: the battle between Reuters and Bloomberg"; Journalism Studies 4.3 (2003).
 Hong, Junhao (2011). ""From the World's Largest Propaganda Machine to a Multipurposed Global News Agency: Factors in and Implications of Xinhua's Transformation Since 1978";". Political Communication. 28 (3): 377–393. doi:10.1080/10584609.2011.572487. S2CID 143208781.
 Hachten, World News Prism (1996), p. 38.
 Lisa M. George & Christiaan Hogendorn, "Local News Online: Aggregators, Geo-Targeting and the Market for Local News"; 1 November 2013.
 ...
 Barbie Zeiler, "Cannibalizing Memory in the Global Flow of News"; in On Media Memory (2011), ed. Neiger, Myers, & Zandberg; pp. 31–34.
 ...
 Hachten, World News Prism (1996), pp. 100–102.
 ...
 McNair, Cultural Chaos (2006), pp. 105–108.
 ...
 C. Anthony Giffard, "Alternative News Agencies", in Boyd-Barrett & Rantanen, The Globalization of News (1998), pp. 192–194.
 ...
 Geniets, Global News Challenge (2013), pp. 22–27.
 Chakravartty and Sarikakis, Media Policy and Globalization (2006), pp. 136–143.
 "Public Journalism and the Problem of Objectivity". Unc.edu. Retrieved 9 March 2012.
 Sue Wallace, "Impartiality in the News", in Fowler-Watt & Allan (eds.), Journalism (2013).
 Allan, News Culture (2004), pp. 20–23.
 Matheson, Donald (2000). ""The birth of news discourse: changes in news language in British newspapers, 1880–1930";". Media, Culture & Society. 22 (5): 557–573. doi:10.1177/016344300022005002. S2CID 145467409.
 Zhong, "Searching for Meaning" (2006), pp. 15, 35.
 Wolfe, Governing Soviet Journalism (2005), p. 29.
 Thomas, Helen (2006). "Spinning the News". Watchdogs of Democracy?: The Waning Washington Press Corps and How It Has Failed the Public. Simon and Schuster. p. 57. ISBN 978-1-4165-4861-4.
 "Re-thinking Objectivity". CJR. Retrieved 9 March 2012.
 ...
 John Soloski, "News Reporting and Professionalism: Some Constraints on Reporting the News", from Media, Culture & Society 11 (1989); reprinted in Berkowitz, Social Meanings of News (1997), pp. 143–145.
 Cranfield, Press and Society (1978), p. 8.
 Allan, News Culture (2004), p. 123.
 Allan, News Culture (2004), p. 129.
 Allan, News Culture (2004), pp. 134–135.
 James S. Ettema, D. Charles Whitney, & Daniel B. Wackman, in Handbook of Communications Science (1987), ed. C.H. Berger & S.H. Chaffee; reprinted in Berkowitz, Social Meanings of News (1997), p. 37.
 Warren Breed, "Social Control in the Newsroom: A Functional Analysis" (pdf), from Social Forces 33 (1955); reprinted in Berkowitz, Social Meanings of News (1997), pp. 108–110.
 ...
 Warren Breed, "Social Control in the Newsroom: A Functional Analysis" (pdf), from Social Forces 33 (1955); reprinted in Berkowitz, Social Meanings of News (1997), pp. 111–114.
 John Soloski, "News Reporting and Professionalism: Some Constraints on Reporting the News", from Media, Culture & Society 11 (1989); reprinted in Berkowitz, Social Meanings of News (1997), pp. 141–142.
 James S. Ettema, D. Charles Whitney, & Daniel B. Wackman, in Handbook of Communications Science (1987), ed. C.H. Berger & S.H. Chaffee; reprinted in Berkowitz, Social Meanings of News (1997), p. 38.
 ...
 David Manning White, "The 'Gate Keeper': A Case Study in the Selection of News", from Journalism Quarterly 27 (1950); reprinted in Berkowitz, Social Meanings of News (1997), p. 63.
 David Manning White, "The 'Gate Keeper': A Case Study in the Selection of News", from Journalism Quarterly 27 (1950); reprinted in Berkowitz, Social Meanings of News (1997), pp. 66–71.
 ...
 Joanna Redden, "The Mediation of Poverty: The News, New Media and Politics"; Dissertation accepted at Goldsmiths, University of London, 2011.
 Jamie Matthews, "Journalists and their sources: The twin challenges of diversity and verification", in Fowler-Watt & Allan (eds.), Journalism (2013).
 John Timmer, "Wikipedia hoax points to limits of journalists' research: A sociology student placed a fake quote on Wikipedia, only to see it show up …"; Ars Technica, 7 May 2009.
 Allan, News Culture (2004), pp. 119–121.
 Allan, News Culture (2004), p. 124.
 Allan, News Culture (2004), pp. 127–129.
 Allan, News Culture (2004), pp. 129–130.
 Salmon, The Newspaper and the Historian (1923), pp. 90–91.
 ...
 Michael Schudson, "The Sociology of News Production", from Media, Culture & Society (1989); reprinted in Berkowitz, Social Meanings of News (1997), p. 14. "One study after another comes up with essentially the same observation, and it matters not whether the study is at the national, state, or local level—the story of journalism, on a day-to-day basis, is the story of the interaction of reporters and officials."
 ...
 James S. Ettema, D. Charles Whitney, & Daniel B. Wackman, in Handbook of Communications Science (1987), ed. C.H. Berger & S.H. Chaffee; reprinted in Berkowitz, Social Meanings of News (1997), pp. 34–37. "In sum, a considerable body of research supports the argument that inter-organizational- and institutional-level forces, realized in a journalistic culture of 'objectivity,' fostered by, and in the service of, progressive liberal capitalism, constrain what journalists report. News thus exhibits an identifiable and widely shared form and a content broadly consonant with the social structures and values of its political-economic context."
 Van Leuven, Sarah; Joye, Stijn (2013). ""Civil Society Organizations at the Gates? A Gatekeeping Study of News Making Efforts by NGOs and Government Institutions";". International Journal of Press/Politics. 19 (2).
 ...
 Geniets, Global News Challenge (2013), p. 47.
 Hachten, World News Prism (1996), pp. 66–67.
 ...
 Parenti, Inventing Reality (1993), pp. 66–68.
 Hachten, World News Prism (1996), pp. 116–118.
 Hachten, World News Prism (1996), pp. 113–116.
 ...
 Geniets, Global News Challenge (2013), p. 8
 Geniets, Global News Challenge (2013), p. 66.
 ...
 Curtin, Patricia A. (1999). "Reevaluating Public Relations Information Subsidies: Market-Driven Journalism and Agenda-Building Theory and Practice". Journal of Public Relations Research. 11 (1): 53–90. doi:10.1207/s1532754xjprr1101_03.
 ...
 Parenti, Inventing Reality (1993), p. 169.
 ...
 Stephens, History of News (1988), p. 5.
 ...
 Bernard Berelson, "What 'missing the newspaper' means", in Communications Research 1948–1949, ed. Lazarsfeld & Stanton; New York: Harper & Brothers, 1949; quoted in Stephens, History of News (1988), p. 17.
 Allan, News Culture (2004), pp. 47–48.
 Allan, News Culture (2004), pp. 113–115.
 Allan, News Culture (2004), pp. 110–112.
 ...
 Motti Neiger, Eyal Zandberg, and Oren Meyers, "Localizing Collective Memory: Radio Broadcasts and the Construction of Regional Memory"; in On Media Memory (2011), ed. Neiger, Myers, & Zandberg; pp. 156–160. "In Israel, radio played a decisive role in establishing and consolidating the nation during the first decades after the creation of the State (Pansler, 2004). The exclusive position enjoyed by radio in the field of electronic broadcasting during the crucial first twenty years of Israel's existence since 1948, when the press was politically divided and television was absent—Israel's first television channel started broadcasting in 1968—gave it much weight in setting the collective agenda."
 ...
 Geniets, Global News Challenge (2013), pp. 17–18.
 McNair, Cultural Chaos (2006), pp. 140–144.
 McNair, Cultural Chaos (2006), pp. 179–185.
 Hachten, World News Prism (1996), pp. 70–72.
 ...
 Dayan & Katz, Media Events (1992), pp. 1–14.
 Dayan & Katz, Media Events (1992), pp. 25–53.
 Dayan & Katz, Media Events (1992), p. 196.
 Paterson, Chris; Andresen, Kenneth; Hoxha, Abit (2011). ""The manufacture of an international news event: The day Kosovo was born";". Journalism. 13 (1): 103–120. doi:10.1177/1464884911400846. S2CID 145715955.
 Perse, Media Effects And Society (2001), 57–61.
 Perse, Media Effects And Society (2001), 73–76.
 Hachten, World News Prism (1996), pp. 73–77.
 ...
 Graber, Doris A. (1980). Mass Media and American Politics. Congressional Quarterly Press.
 "Queen's University – Department of Political Studies". Queen's University.
 Perse, Media Effects And Society 2001; 55.
 ...
 Terr; et al. (1999). "Children's symptoms in the wake of Challenger: a field study of distant-traumatic effects and an outline of related conditions". American Journal of Psychiatry. 156 (10): 1536–44. doi:10.1176/ajp.156.10.1536. PMID 10518163.
 Gavin Rees, "The Trauma Factor", in Fowler-Watt & Allan (eds.), Journalism (2013).
 Altheide, David L. (1997). "The News Media, the Problem Frame, and the Production of Fear". Sociological Quarterly. 38 (4): 647–668. doi:10.1111/j.1533-8525.1997.tb00758.x.
 Perse, Media Effects And Society (2001), 1–10.
 ...
 Perse, Media Effects And Society (2001), 98–99.
 ...
 Tien Vu, Hong; Guo, Lei; McCombs, Maxwell E. (2014). "Exploring 'the World Outside and the Pictures in Our Heads': A Network Agenda-Setting Study". Journalism and Mass Communication Quarterly. 91 (4).
 "Brands set to 'stay classy' with Anchorman 2". 5 November 2013.
 "How nonstop marketing killed my buzz for Anchorman 2". theweek.com. 19 December 2013.
 "OPINION EXCHANGE | Don Shelby: An anchorman's take on 'Anchorman 2'". Star Tribune.
 "How Facebook stole the news business".
 "Facebook announces $300 million local news investment". NBC News.
 "Facebook investing $300 million in local news initiatives". www.cbsnews.com.
...
Palmer, Michael B. International News Agencies (Palgrave Macmillan, Cham, 2019) excerpt
Parsons, Wayne. The Power of the Financial Press: Journalism and economic opinion in Britain and America (Edward Elgar, 1989). ISBN 1-85278-039-8
...
Zhong, Bu. "Searching for Meaning: Multi-Level Cognitive Processing of News Decision Making Among U.S. and Chinese Journalists". Dissertation accepted at University of Maryland, College Park, 2006. It is shown by default, until the collapse plugin adds the appropriate classes that we use to style each element. These classes control the overall appearance, as well as the showing and hiding via CSS transitions. You can modify any of this with custom CSS or overriding our default variables. It's also worth noting that just about any HTML can go within the <code>.accordion-body</code>, though the transition does limit overflow.
      </div>
    </div>
  </div>
  <div class="accordion-item">
    ...
    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
      <div class="accordion-body">
        <strong>This is the second item's accordion body.</strong> News is information about current events. This may be provided through many different media: word of mouth, printing, postal systems, broadcasting, electronic communication, or through the testimony of observers and witnesses to events. News is sometimes called "hard news" to differentiate it from soft media.
...
The beliefs that "news" is derived from an acronym of the phrase “Notable Events, Weather, and Sports”, or that it is formed from the first letters of the compass (North, East, West, South) are incorrect, or would be considered examples of a backronym.[3]
...
Another corollary of the newness of news is that, as new technology enables new media to disseminate news more quickly, 'slower' forms of communication may move away from 'news' towards 'analysis'.[13]

Commodity
According to some theories, "news" is whatever the news industry sells.[14] Journalism, broadly understood along the same lines, is the act or occupation of collecting and providing news.[15][16] From a commercial perspective, news is simply one input, along with paper (or an electronic server) necessary to prepare a final product for distribution.[17] A news agency supplies this resource "wholesale" and publishers enhance it for retail.[18][19]

Tone
Most purveyors of news value impartiality, neutrality, and objectivity, despite the inherent difficulty of reporting without political bias.[20] Perception of these values has changed greatly over time as sensationalized 'tabloid journalism' has risen in popularity. Michael Schudson has argued that before the era of World War I and the concomitant rise of propaganda, journalists were not aware of the concept of bias in reporting, let alone actively correcting for it.[21] News is also sometimes said to portray the truth, but this relationship is elusive and qualified.[22]

Paradoxically, another property commonly attributed to news is sensationalism, the disproportionate focus on, and exaggeration of, emotive stories for public consumption.[23][24] This news is also not unrelated to gossip, the human practice of sharing information about other humans of mutual interest.[25] A common sensational topic is violence; hence another news dictum, "if it bleeds, it leads".[26]

Newsworthiness
Newsworthiness is defined as a subject having sufficient relevance to the public or a special audience to warrant press attention or coverage.[27]

News values seem to be common across cultures. People seem to be interested in news to the extent which it has a big impact, describes conflicts, happens nearby, involves well-known people, and deviates from the norms of everyday happenings.[28] War is a common news topic, partly because it involves unknown events that could pose personal danger.[29]
...
Before the invention of newspapers in the early 17th century, official government bulletins and edicts were circulated at times in some centralized empires.[36] The first documented use of an organized courier service for the diffusion of written documents is in Egypt, where Pharaohs used couriers for the diffusion of their decrees in the territory of the State (2400 BC).[37] Julius Caesar regularly publicized his heroic deeds in Gaul, and upon becoming dictator of Rome began publishing government announcements called Acta Diurna. These were carved in metal or stone and posted in public places.[38][39] In medieval England, parliamentary declarations were delivered to sheriffs for public display and reading at the market.[40]

Specially sanctioned messengers have been recognized in Vietnamese culture, among the Khasi people in India, and in the Fox and Winnebago cultures of the American midwest. The Zulu Kingdom used runners to quickly disseminate news. In West Africa, news can be spread by griots. In most cases, the official spreaders of news have been closely aligned with holders of political power.[41]

Town criers were a common means of conveying information to citydwellers. In thirteenth-century Florence, criers known as banditori arrived in the market regularly, to announce political news, to convoke public meetings, and to call the populace to arms. In 1307 and 1322–1325, laws were established governing their appointment, conduct, and salary. These laws stipulated how many times a banditoro was to repeat a proclamation (forty) and where in the city they were to read them.[42] Different declarations sometimes came with additional protocols; announcements regarding the plague were also to be read at the city gates.[43] These proclamations all used a standard format, beginning with an exordium—"The worshipful and most esteemed gentlemen of the Eight of Ward and Security of the city of Florence make it known, notify, and expressly command, to whosoever, of whatever status, rank, quality and condition"—and continuing with a statement (narratio), a request made upon the listeners (petitio), and the penalty to be exacted from those who would not comply (peroratio).[44] In addition to major declarations, bandi (announcements) might concern petty crimes, requests for information, and notices about missing slaves.[45] Niccolò Machiavelli was captured by the Medicis in 1513, following a bando calling for his immediate surrender.[46] Some town criers could be paid to include advertising along with news.[47]

Under the Ottoman Empire, official messages were regularly distributed at mosques, by traveling holy men, and by secular criers. These criers were sent to read official announcements in marketplaces, highways, and other well-traveled places, sometimes issuing commands and penalties for disobedience.[48]

Early news networks
The spread of news has always been linked to the communications networks in place to disseminate it. Thus, political, religious, and commercial interests have historically controlled, expanded, and monitored communications channels by which news could spread. Postal services have long been closely entwined with the maintenance of political power in a large area.[49][50]

One of the imperial communication channels, called the "Royal Road" traversed the Assyrian Empire and served as a key source of its power.[51] The Roman Empire maintained a vast network of roads, known as cursus publicus, for similar purposes.[52]

Visible chains of long-distance signaling, known as optical telegraphy, have also been used throughout history to convey limited types of information. These can have ranged from smoke and fire signals to advanced systems using semaphore codes and telescopes.[53][54] The latter form of optical telegraph came into use in Japan, Britain, France, and Germany from the 1790s through the 1850s.[55][56]

Asia

Reproduction of Kaiyuan Za Bao court newspaper from the Tang dynasty
The world's first written news may have originated in eighth century BCE China, where reports gathered by officials were eventually compiled as the Spring and Autumn Annals. The annals, whose compilation is attributed to Confucius, were available to a sizeable reading public and dealt with common news themes—though they straddle the line between news and history.[57] The Han dynasty is credited with developing one of the most effective imperial surveillance and communications networks in the ancient world.[58] Government-produced news sheets, called tipao, circulated among court officials during the late Han dynasty (second and third centuries AD). Between 713 and 734, the Kaiyuan Za Bao ("Bulletin of the Court") of the Chinese Tang Dynasty published government news; it was handwritten on silk and read by government officials.[59] The court created a Bureau of Official Reports (Jin Zhouyuan) to centralize news distribution for the court.[60] Newsletters called ch'ao pao continued to be produced and gained wider public circulation in the following centuries.[61] In 1582 there was the first reference to privately published newssheets in Beijing, during the late Ming Dynasty.[62][63]

Japan had effective communications and postal delivery networks at several points in its history, first in 646 with the Taika Reform and again during the Kamakura period from 1183 to 1333. The system depended on hikyaku, runners, and regularly spaced relay stations. By this method, news could travel between Kyoto and Kamakura in 5–7 days. Special horse-mounted messengers could move information at the speed of 170 kilometers per day.[56][64] The Japanese shogunates were less tolerant than the Chinese government of news circulation.[59] The postal system established during the Edo period was even more effective, with average speeds of 125–150 km/day and express speed of 200 km/day. This system was initially used only by the government, taking private communications only at exorbitant prices. Private services emerged and in 1668 established their own nakama (guild). They became even faster, and created an effective optical telegraphy system using flags by day and lanterns and mirrors by night.[56]

Europe
In Europe, during the Middle Ages, elites relied on runners to transmit news over long distances. At 33 kilometres per day, a runner would take two months to bring a message across the Hanseatic League from Bruges to Riga.[65][66] In the early modern period, increased cross-border interaction created a rising need for information which was met by concise handwritten newssheets. The driving force of this new development was the commercial advantage provided by up-to-date news.[8][67]

In 1556, the government of Venice first published the monthly Notizie scritte, which cost one gazetta.[68] These avvisi were handwritten newsletters and used to convey political, military, and economic news quickly and efficiently to Italian cities (1500–1700)—sharing some characteristics of newspapers though usually not considered true newspapers.[69] Avvisi were sold by subscription under the auspices of military, religious, and banking authorities. Sponsorship flavored the contents of each series, which were circulated under many different names. Subscribers included clerics, diplomatic staff, and noble families. By the last quarter of the seventeenth century, long passages from avvisi were finding their way into published monthlies such as the Mercure de France and, in northern Italy, Pallade veneta.[70][71][72]


Some European postal routes in 1563
Postal services enabled merchants and monarchs to stay abreast of important information. For the Holy Roman Empire, Emperor Maximillian I in 1490 authorized two brothers from the Italian Tasso family, Francesco and Janetto, to create a network of courier stations linked by riders. They began with a communications line between Innsbruck and Mechelen and grew from there.[73] In 1505 this network expanded to Spain, new governed by Maximilian's son Philip. These riders could travel 180 kilometers in a day.[74] This system became the Imperial Reichspost, administered by Tasso descendants (subsequently known as Thurn-und-Taxis), who in 1587 received exclusive operating rights from the Emperor.[73] The French postal service and English postal service also began at this time, but did not become comprehensive until the early 1600s.[73][75][76] In 1620, the English system linked with Thurn-und-Taxis.[54]

These connections underpinned an extensive system of news circulation, with handwritten items bearing dates and places of origin. Centred in Germany, the network took in news from Russia, the Balkans, Italy, Britain, France, and the Netherlands.[77] The German lawyer Christoph von Scheurl and the Fugger house of Augsburg were prominent hubs in this network.[78] Letters describing historically significant events could gain wide circulation as news reports. Indeed, personal correspondence sometimes acted only as a convenient channel through which news could flow across a larger network.[79] A common type of business communication was a simple listing of current prices, the circulation of which quickened the flow of international trade.[80][81] Businesspeople also wanted to know about events related to shipping, the affairs of other businesses, and political developments.[80] Even after the advent of international newspapers, business owners still valued correspondence highly as a source of reliable news that would affect their enterprise.[82] Handwritten newsletters, which could be produced quickly for a limited clientele, also continued into the 1600s.[78]
...
The spread of paper and the printing press from China to Europe preceded a major advance in the transmission of news.[83] With the spread of printing presses and the creation of new markets in the 1500s, news underwent a shift from factual and precise economic reporting, to a more emotive and freewheeling format. (Private newsletters containing important intelligence therefore remained in use by people who needed to know.)[84] The first newspapers emerged in Germany in the early 1600s.[85] Relation aller Fürnemmen und gedenckwürdigen Historien, from 1605, is recognized as the world's first formalized 'newspaper';[86] while not a 'newspaper' in the modern sense, the Ancient Roman acta diurna served a similar purpose circa 131 BC.

The new format, which mashed together numerous unrelated and perhaps dubious reports from far-flung locations, created a radically new and jarring experience for its readers.[87] A variety of styles emerged, from single-story tales, to compilations, overviews, and personal and impersonal types of news analysis.[88]

News for public consumption was at first tightly controlled by governments. By 1530, England had created a licensing system for the press and banned "seditious opinions".[89] Under the Licensing Act, publication was restricted to approved presses—as exemplified by The London Gazette, which prominently bore the words: "Published By Authority".[90] Parliament allowed the Licensing Act to lapse in 1695, beginning a new era marked by Whig and Tory newspapers.[91] (During this era, the Stamp Act limited newspaper distribution simply by making them expensive to sell and buy.) In France, censorship was even more constant.[92] Consequently, many Europeans read newspapers originating from beyond their national borders—especially from the Dutch Republic, where publishers could evade state censorship.[93]

The new United States saw a newspaper boom beginning with the Revolutionary era, accelerated by spirited debates over the establishment of a new government, spurred on by subsidies contained in the 1792 Postal Service Act, and continuing into the 1800s.[94][95] American newspapers got many of their stories by copying reports from each other. Thus by offering free postage to newspapers wishing to exchange copies, the Postal Service Act subsidized a rapidly growing news network through which different stories could percolate.[96] Newspapers thrived during the colonization of the West, fueled by high literacy and a newspaper-loving culture.[97] By 1880, San Francisco rivaled New York in number of different newspapers and in printed newspaper copies per capita.[98] Boosters of new towns felt that newspapers covering local events brought legitimacy, recognition, and community.[99] The 1830s American, wrote Alexis de Tocqueville, was "a very civilized man prepared for a time to face life in the forest, plunging into the wilderness of the New World with his Bible, ax, and newspapers."[100] In France, the Revolution brought forth an abundance of newspapers and a new climate of press freedom, followed by a return to repression under Napoleon.[101] In 1792 the Revolutionaries set up a news ministry called the Bureau d'Esprit.[102]

Some newspapers published in the 1800s and after retained the commercial orientation characteristic of the private newsletters of the Renaissance. Economically oriented newspapers published new types of data enabled the advent of statistics, especially economic statistics which could inform sophisticated investment decisions.[103] These newspapers, too, became available for larger sections of society, not just elites, keen on investing some of their savings in the stock markets. Yet, as in the case other newspapers, the incorporation of advertising into the newspaper led to justified reservations about accepting newspaper information at face value.[104] Economic newspapers also became promoters of economic ideologies, such as Keynesianism in the mid-1900s.[105]

Newspapers came to sub-Saharan Africa via colonization. The first English-language newspaper in the area was The Royal Gazette and Sierra Leone Advertiser, established in 1801, and followed by The Royal Gold Coast Gazette and Commercial Intelligencer in 1822 and the Liberia Herald in 1826.[106] A number of nineteenth-century African newspapers were established by missionaries.[107] These newspapers by and large promoted the colonial governments and served the interests of European settlers by relaying news from Europe.[107] The first newspaper published in a native African language was the Muigwithania, published in Kikuyu by the Kenyan Central Association.[107] Muigwithania and other newspapers published by indigenous Africans took strong opposition stances, agitating strongly for African independence.[108] Newspapers were censored heavily during the colonial period—as well as after formal independence. Some liberalization and diversification took place in the 1990s.[109]

Newspapers were slow to spread to the Arab world, which had a stronger tradition of oral communication, and mistrust of the European approach to news reporting. By the end of the eighteenth century, the Ottoman Empire's leaders in Istanbul monitored the European press, but its contents were not disseminated for mass consumption.[110] Some of the first written news in modern North Africa arose in Egypt under Muhammad Ali, who developed the local paper industry and initiated the limited circulation of news bulletins called jurnals.[111] Beginning in the 1850s and 1860s, the private press began to develop in the multi-religious country of Lebanon.[112]

Newswire
The development of the electrical telegraph, which often travelled along railroad lines, enabled news to travel faster, over longer distances.[113] (Days before Morse's Baltimore–Washington line transmitted the famous question, "What hath God wrought?", it transmitted the news that Henry Clay and Theodore Frelinghuysen had been chosen by the Whig nominating party.)[38] Telegraph networks enabled a new centralization of the news, in the hands of wire services concentrated in major cities. The modern form of these originated with Charles-Louis Havas, who founded Bureau Havas (later Agence France-Presse) in Paris. Havas began in 1832, using the French government's optical telegraph network. In 1840 he began using pigeons for communications to Paris, London, and Brussels. Havas began to use the electric telegraph when it became available.[114]

One of Havas's proteges, Bernhard Wolff, founded Wolffs Telegraphisches Bureau in Berlin in 1849.[115] Another Havas disciple, Paul Reuter, began collecting news from Germany and France in 1849, and in 1851 immigrated to London, where he established the Reuters news agency—specializing in news from the continent.[116] In 1863, William Saunders and Edward Spender formed the Central Press agency, later called the Press Association, to handle domestic news.[117] Just before insulated telegraph line crossed the English Channel in 1851, Reuter won the right to transmit stock exchange prices between Paris and London.[118] He maneuvered Reuters into a dominant global position with the motto "Follow the Cable", setting up news outposts across the British Empire in Alexandria (1865), Bombay (1866), Melbourne (1874), Sydney (1874), and Cape Town (1876).[118][119] In the United States, the Associated Press became a news powerhouse, gaining a lead position through an exclusive arrangement with the Western Union company.[120]

The telegraph ushered in a new global communications regime, accompanied by a restructuring of the national postal systems, and closely followed by the advent of telephone lines. With the value of international news at a premium, governments, businesses, and news agencies moved aggressively to reduce transmission times. In 1865, Reuters had the scoop on the Lincoln assassination, reporting the news in England twelve days after the event took place.[121] In 1866, an undersea telegraph cable successfully connected Ireland to Newfoundland (and thus the Western Union network) cutting trans-Atlantic transmission time from days to hours.[122][123][124] The transatlantic cable allowed fast exchange of information about the London and New York stock exchanges, as well as the New York, Chicago, and Liverpool commodity exchanges—for the price of $5–10, in gold, per word.[125] Transmitting On 11 May 1857, a young British telegraph operator in Delhi signaled home to alert the authorities of the Indian Rebellion of 1857. The rebels proceeded to disrupt the British telegraph network, which was rebuilt with more redundancies.[126] In 1902–1903, Britain and the U.S. completed the circumtelegraphy of the planet with transpacific cables from Canada to Fiji and New Zealand (British Empire), and from the US to Hawaii and the occupied Philippines.[127] U.S. reassertions of the Monroe Doctrine notwithstanding, Latin America was a battleground of competing telegraphic interests until World War I, after which U.S. interests finally did consolidate their power in the hemisphere.[128]


World railway and telegraph system, 1900
By the turn of the century (i.e., circa 1900), Wolff, Havas, and Reuters formed a news cartel, dividing up the global market into three sections, in which each had more-or-less exclusive distribution rights and relationships with national agencies.[129] Each agency's area corresponded roughly to the colonial sphere of its mother country.[130] Reuters and the Australian national news service had an agreement to exchange news only with each other.[131] Due to the high cost of maintaining infrastructure, political goodwill, and global reach, newcomers found it virtually impossible to challenge the big three European agencies or the American Associated Press.[132] In 1890 Reuters (in partnership with the Press Association, England's major news agency for domestic stories) expanded into "soft" news stories for public consumption, about topics such as sports and "human interest".[133] In 1904, the big three wire services opened relations with Vestnik, the news agency of Czarist Russia, to their group, though they maintained their own reporters in Moscow.[134] During and after the Russian Revolution, the outside agencies maintained a working relationship with the Petrograd Telegraph Agency, renamed the Russian Telegraph Agency (ROSTA) and eventually the Telegraph Agency of the Soviet Union (TASS).[135]

The Chinese Communist Party created its news agency, the Red China News Agency, in 1931; its primary responsibilities were the Red China newspaper and the internal Reference News. In 1937, the Party renamed the agency Xinhua, New China. Xinhua became the official news agency of the People's Republic of China in 1949.[136]

These agencies touted their ability to distill events into "minute globules of news", 20–30 word summaries which conveyed the essence of new developments.[135] Unlike newspapers, and contrary to the sentiments of some of their reporters, the agencies sought to keep their reports simple and factual.[137] The wire services brought forth the "inverted pyramid" model of news copy, in which key facts appear at the start of the text, and more and more details are included as it goes along.[122] The sparse telegraphic writing style spilled over into newspapers, which often reprinted stories from the wire with little embellishment.[19][138] In a 20 September 1918 Pravda editorial, Lenin instructed the Soviet press to cut back on their political rambling and produce many short anticapitalist news items in "telegraph style".[139]

As in previous eras, the news agencies provided special services to political and business clients, and these services constituted a significant portion of their operations and income. The wire services maintained close relationships with their respective national governments, which provided both press releases and payments.[140] The acceleration and centralization of economic news facilitated regional economic integration and economic globalization. "It was the decrease in information costs and the increasing communication speed that stood at the roots of increased market integration, rather than falling transport costs by itself. In order to send goods to another area, merchants needed to know first whether in fact to send off the goods and to what place. Information costs and speed were essential for these decisions."[141]

Radio and television
The British Broadcasting Company began transmitting radio news from London in 1922, dependent entirely, by law, on the British news agencies.[142] BBC radio marketed itself as a news by and for social elites, and hired only broadcasters who spoke with upper-class accents.[143] The BBC gained importance in the May 1926 general strike, during which newspapers were closed and the radio served as the only source of news for an uncertain public. (To the displeasure of many listeners, the BBC took an unambiguously pro-government stance against the strikers).[142][144]

In the US, RCA's Radio Group established its radio network, NBC, in 1926. The Paley family founded CBS soon after. These two networks, which supplied news broadcasts to subsidiaries and affiliates, dominated the airwaves throughout the period of radio's hegemony as a news source.[145] Radio broadcasters in the United States negotiated a similar arrangement with the press in 1933, when they agreed to use only news from the Press–Radio Bureau and eschew advertising; this agreement soon collapsed and radio stations began reporting their own news (with advertising).[146] As in Britain, American news radio avoided "controversial" topics as per norms established by the National Association of Broadcasters.[147] By 1939, 58% of Americans surveyed by Fortune considered radio news more accurate than newspapers, and 70% chose radio as their main news source.[147] Radio expanded rapidly across the continent, from 30 stations in 1920 to a thousand in the 1930s. This operation was financed mostly with advertising and public relations money.[148]
...
The war provided an opportunity to expand radio and take advantage of its new potential. The BBC reported on Allied invasion of Normandy on 8:00 a.m. of the morning it took place, and including a clip from German radio coverage of the same event. Listeners followed along with developments throughout the day.[150] The U.S. set up its Office of War Information which by 1942 sent programming across South America, the Middle East, and East Asia.[151] Radio Luxembourg, a centrally located high-power station on the continent, was seized by Germany, and then by the United States—which created fake news programs appearing as though they were created by Germany.[152] Targeting American troops in the Pacific, the Japanese government broadcast the "Zero Hour" program, which included news from the U.S. to make the soldiers homesick.[153] But by the end of the war, Britain had the largest radio network in the world, broadcasting internationally in 43 different languages.[154] Its scope would eventually be surpassed (by 1955) by the worldwide Voice of America programs, produced by the United States Information Agency.[155]

In Britain and the United States, television news watching rose dramatically in the 1950s and by the 1960s supplanted radio as the public's primary source of news.[156] In the U.S., television was run by the same networks which owned radio: CBS, NBC, and an NBC spin-off called ABC.[157] Edward R. Murrow, who first entered the public ear as a war reporter in London, made the big leap to television to become an iconic newsman on CBS (and later the director of the United States Information Agency).[158]

Ted Turner's creation of the Cable News Network (CNN) in 1980 inaugurated a new era of 24-hour satellite news broadcasting. In 1991, the BBC introduced a competitor, BBC World Service Television. Rupert Murdoch's Australian News Corporation entered the picture with Fox News Channel in the US, Sky News in Britain, and STAR TV in Asia.[159] Combining this new apparatus with the use of embedded reporters, the United States waged the 1991–1992 Gulf War with the assistance of nonstop media coverage.[160] CNN's specialty is the crisis, to which the network is prepared to shift its total attention if so chosen.[161] CNN news was transmitted via INTELSAT communications satellites.[162] CNN, said an executive, would bring a "town crier to the global village".[163]

In 1996, the Qatar-owned broadcaster Al Jazeera emerged as a powerful alternative to the Western media, capitalizing in part on anger in the Arab & Muslim world regarding biased coverage of the Gulf War. Al Jazeera hired many news workers conveniently laid off by BBC Arabic Television, which closed in April 1996. It used Arabsat to broadcast.[159]

Internet
The early internet, known as ARPANET, was controlled by the U.S. Department of Defense and used mostly by academics. It became available to a wider public with the release of the Netscape browser in 1994.[164] At first, news websites were mostly archives of print publications.[165] An early online newspaper was the Electronic Telegraph, published by The Daily Telegraph.[166][167] A 1994 earthquake in California was one of the first big stories to be reported online in real time.[168] The new availability of web browsing made news sites accessible to more people.[168] On the day of the Oklahoma City bombing in April 1995, people flocked to newsgroups and chatrooms to discuss the situation and share information. The Oklahoma City Daily posted news to its site within hours. Two of the only news sites capable of hosting images, the San Jose Mercury News and Time magazine, posted photographs of the scene.[168]

Quantitatively, the internet has massively expanded the sheer volume of news items available to one person. The speed of news flow to individuals has also reached a new plateau.[169] This insurmountable flow of news can daunt people and cause information overload. Zbigniew Brzezinski called this period the "technetronic era", in which "global reality increasingly absorbs the individual, involves him, and even occasionally overwhelms him."[170]
...
News media today
News can travel through different communication media.[18] In modern times, printed news had to be phoned into a newsroom or brought there by a reporter, where it was typed and either transmitted over wire services or edited and manually set in type along with other news stories for a specific edition. Today, the term "breaking news" has become trite as commercial broadcasting United States cable news services that are available 24 hours a day use live communications satellite technology to bring current events into consumers' homes as the event occurs. Events that used to take hours or days to become common knowledge in towns or in nations are fed instantaneously to consumers via radio, television, mobile phone, and the internet.

Speed of news transmission, of course, still varies wildly on the basis of where and how one lives.[171]

Newspaper

A newspaper is one of the most common ways to receive the latest news.
Main article: Newspaper
Most large cities in the United States historically had morning and afternoon newspapers. With the addition of new communications media, afternoon newspapers have shut down and morning newspapers have lost circulation. Weekly newspapers have somewhat increased.[172] In more and more cities, newspapers have established local market monopolies—i.e., a single newspaper is the only one in town. This process has accelerated since the 1980s, commensurate with a general trend of consolidation in media ownership.[173] In China, too, newspapers have gained exclusive status, city-by-city, and pooled into large associations such as Chengdu Business News. These associations function like news agencies, challenging the hegemony of Xinhua as a news provider.[136]

The world's top three most circulated newspapers all publish from Japan.

About one-third of newspaper revenue comes from sales; the majority comes from advertising.[174] Newspapers have struggled to maintain revenue given declining circulation and the free flow of information over the internet; some have implemented paywalls for their websites.[166]

In the U.S., many newspapers have shifted their operations online, publishing around the clock rather than daily in order to keep pace with the internet society. Prognosticators have suggested that print newspapers will vanish from the U.S. in 5–20 years.[166] Many newspapers have started to track social media engagement for trending news stories to cover. It is hidden by default, until the collapse plugin adds the appropriate classes that we use to style each element. These classes control the overall appearance, as well as the showing and hiding via CSS transitions. You can modify any of this with custom CSS or overriding our default variables. It's also worth noting that just about any HTML can go within the <code>.accordion-body</code>, though the transition does limit overflow.
      </div>
    </div>
  </div>
  <div class="accordion-item">
    ...
    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
      <div class="accordion-body">
        <strong>This is the third item's accordion body.</strong> News websites are sites devoted to delivering the news in a different format than television, print or radio. News sites include sites that have a large variety of information which may not be considered "news" by all audiences, but may include entertainment, games, news that may not be current but is interesting, or other miscellaneous information. An example of a site like this is MSN.com.

Another type of news site is the site that is completely devoted to news. These sites may include all types of news like political, judicial, entertainment, sports or more. An example of this type of site is CNN.com.

Also, there are many news sites devoted to one particular type of news or certain activity. For instance, there may be a website completely devoted to one sport or to a certain hobby.

 

ExperienceTop
I have never had experience creating or editing a news website. I would guess that probably very few people have. However, the majority of people have probably had experience visiting and surfing news websites. Along with many other people, I use MSN.com as my homepage, which not only includes a convenient link to my hotmail, but usually grabs my attention with a picture or interesting headline. I don't have much experience with specifically news websites, or websites devoted to a certain topic. However, by simply googling any sport or subject you are interested in, you are likely to find a news site devoted to it.

 

AnalysisTop
Writing for a news website is similar to writing news in other mediums, but the handling of the website is different. The writing still needs to be concise and direct, if not more than other news because there is more to pull the reader's attention to other articles, or even other sites than a print or television medium. The site would probably still be organized with the big story on the top or the biggest section, much like the newspaper. A completely news site would also be organized into sections such as news, sports and entertainment.

News sites differ from other mediums because they have a greater responsibility to provide the latest news first becaue they don't have to wait until the broadcast like television, or wait until the next printing like newspaper. Because of this, journalists need to be sure they are still providing accurate news and not just jumping to get something up on their website.It is hidden by default, until the collapse plugin adds the appropriate classes that we use to style each element. These classes control the overall appearance, as well as the showing and hiding via CSS transitions. You can modify any of this with custom CSS or overriding our default variables. It's also worth noting that just about any HTML can go within the <code>.accordion-body</code>, though the transition does limit overflow.
      </div>
    </div>
  </div>
</div>
<img src={L} alt="Error" style={{width:'100%',height:'100vh'}} />
